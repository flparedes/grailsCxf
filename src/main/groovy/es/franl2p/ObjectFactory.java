 ...
 * generated in the es.franl2p package. 
...
public class ObjectFactory {
    ...
    private final static QName _BuscarProductoPorId_QNAME = new QName("http://franl2p.wordpress.com/", "buscarProductoPorId");
    private final static QName _BuscarProductoPorIdResponse_QNAME = new QName("http://franl2p.wordpress.com/", "buscarProductoPorIdResponse");
    private final static QName _BuscarProductos_QNAME = new QName("http://franl2p.wordpress.com/", "buscarProductos");
    private final static QName _BuscarProductosResponse_QNAME = new QName("http://franl2p.wordpress.com/", "buscarProductosResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.franl2p
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://franl2p.wordpress.com/", name = "buscarProductoPorId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://franl2p.wordpress.com/", name = "buscarProductoPorIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://franl2p.wordpress.com/", name = "buscarProductos")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://franl2p.wordpress.com/", name = "buscarProductosResponse")
